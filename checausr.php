...
$servername = "localhost";
    $database = "id15181532_usuarios";
    $username = "id15181532_usu";
    $password = "qK&dQk5+H2r~2>=[";
    // Create connection
        ...
        $sql = mysqli_query($conn, $consulta);
          while($row = mysqli_fetch_array($sql))
          {
            ...
            echo "<td>" . $row["correo"] . "</font></td>";
        	    echo "&nbsp&nbsp&nbsp";
            echo "<td>" . $row["login"]."<center><button class='button is-success' style='background-color:#097eda;'>&nbsp;Editar&nbsp;</button>&nbsp;<button class='button is-success' style='background-color:red;'>&nbsp;Borrar&nbsp;</button></center>"."</font></td></tr>";   
        	    echo "<br>";
          }
